...
cks_stars_path = '../cks_binaries/data/literature_data/Petigura2017_Table5.fits'
cks_stars = Table(fits.open(cks_stars_path)[1].data).to_pandas()
print(len(cks_stars), 'stars from CKS')
...
cks_stars = cks_stars[cks_cols_to_keep].rename(
    columns={
    "Name": "id_starname", 
    "Obs": "obs_id",
    "Teff": "teff",
